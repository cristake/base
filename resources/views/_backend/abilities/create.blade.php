...
@section('meta')
    <title>Adaugare abilitate noua</title>
	...
	<div class="row">
	    <div class="col-lg-12">
	        <h2 class="page-header" id="simple-msg">
				Adaugare abilitate noua
				{!! HTML::decode( link_to_route('abilities', '<i class="fa fa-arrow-left"></i> Inapoi', [], ['class' => 'btn btn-info pull-right']) ) !!}
	        </h2>
	    </div>
	</div>
	<!-- End page header -->
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<!-- Form Display -->
					{!! Form::open(['route' => 'abilities_store', 'class' => 'form-horizontal', 'method' => 'POST']) !!}
